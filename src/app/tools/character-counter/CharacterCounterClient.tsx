...
export default function CharacterCounterClient() {
  ...
  return (
    <div className="max-w-4xl mx-auto py-12 px-4">
      <h1 className="text-3xl font-bold mb-2 text-navy">Character Counter</h1>
      <p className="text-gray-600 mb-8">
        Get instant character count, word count, and reading time for your text.
      </p>
      ...
      <div className="mt-12 prose max-w-none text-gray-600">
        <h3>Why use a Character Counter?</h3>
        <p>
          Whether you're writing for social media, meta descriptions, or academic requirements, 
          staying within character limits is often essential. Our character counter provides real-time stats 
          to help you hit your target length perfectly every time.
        </p>
      </div>
    </div>
  );

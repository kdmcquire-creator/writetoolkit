        ...
        <div className="prose prose-blue max-w-none bg-white p-8 rounded-lg border border-gray-200">
          <section className="mb-8">
            ...
            <p className="text-gray-700">
              Our tools are designed for writers, editors, and students who need quick, reliable results without the bloat of complex software. Whether you are using our <Link href="/tools/word-counter" className="text-blue-600 hover:underline">Word Counter</Link> or <Link href="/tools/grammar-checker" className="text-blue-600 hover:underline">Grammar Checker</Link>, you get professional-grade utility for free.
            </p>
          </section>
          ...
          <section className="mb-8">
            ...
            <p className="text-gray-700 mb-4">
              Using our tools is simple. Select a tool from the grid above, paste your text into the input area, and get instant results. For example, our <Link href="/tools/headline-analyzer" className="text-blue-600 hover:underline">Headline Analyzer</Link> provides immediate feedback on your titles.
            </p>
            <p className="text-gray-700">
              For more information on how we handle your data, please visit our <Link href="/disclosure" className="text-blue-600 hover:underline">disclosure page</Link>.
            </p>
          </section>
